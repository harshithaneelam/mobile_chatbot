...
from retrieval.retrive_documents import Retrieval  # Updated import path
...
assistant_agent = AssistantAgent(
    ...
    system_message="""You are a helpful mobile store assistant. 
    Answer concisely using any retrieved context."""
)

# ===================== FUNCTIONS ===================== #
def get_response(user_query: str, top_k: int = 5) -> str:
    """
    Fetches PDF chunks, use AssistantAgent for response, 
    and fallback to Azure OpenAI if needed.
    Checks context relevance before answering.
